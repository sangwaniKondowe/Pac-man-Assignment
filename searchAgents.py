    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                cost = 1
                nextNode.append( ( (nextState, tuple(cornersVisited)), action, cost, ) )
...
def cornersHeuristic(state, problem):
    ...
    if len(unvisitedCorners) > 0:
        ...
        #distance between current location and closest node
        currentToClosest = mazeDistance(currentLocation, closestNode, currentNode)

        #distance between closest node and farthest node
...
def foodHeuristic(state, problem):
    ...
    if len(foodList) > 0:
        ...
        #distance between closest manhattan node and farthest node
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
       # util.raiseNotDefined()      pasted here
